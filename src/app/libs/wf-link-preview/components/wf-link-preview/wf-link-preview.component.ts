...
@Component({
  selector: 'app-wf-link-preview',
  exportAs: 'WfLinkPreview',
  templateUrl: './wf-link-preview.component.html',
  styleUrls: ['./wf-link-preview.component.scss']
})
export class WfLinkPreviewComponent implements OnInit {
