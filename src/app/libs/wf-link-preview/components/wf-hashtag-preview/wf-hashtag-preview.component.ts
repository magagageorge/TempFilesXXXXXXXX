...
@Component({
  selector: 'app-wf-hashtag-preview',
  templateUrl: './wf-hashtag-preview.component.html',
  styleUrls: ['./wf-hashtag-preview.component.scss']
})
export class WfHashtagPreviewComponent implements OnInit {
  ...
  ngOnInit(): void {
    var _this=this;
    if (this.link && this.link.type=='hashtag' && !this.linkPreview ) {
      // this.loaded = false;
