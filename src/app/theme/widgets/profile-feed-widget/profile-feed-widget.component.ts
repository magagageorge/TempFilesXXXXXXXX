...
export class ProfileFeedWidgetComponent implements AfterViewInit {
  ...
  constructor(feedService: FeedService,appModalService:AppModalService, postingService: PostingService, commentService: CommentsService,imageIconsService: ImageIconsService, urlViewerService: UrlViewerService, hovercardService: HoverCardService) {
