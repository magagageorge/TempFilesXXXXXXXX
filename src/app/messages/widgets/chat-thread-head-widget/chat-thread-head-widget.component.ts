...
@Component({
  selector: 'app-chat-thread-head-widget',
  templateUrl: './chat-thread-head-widget.component.html',
  styleUrls: ['./chat-thread-head-widget.component.scss']
})
export class ChatThreadHeadWidgetComponent implements OnInit {
