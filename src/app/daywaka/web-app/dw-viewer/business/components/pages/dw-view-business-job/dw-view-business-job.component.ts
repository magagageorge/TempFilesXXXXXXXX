...
export class DwViewBusinessJobComponent implements OnInit {
  ...
  constructor(public daywakaService: DaywakaService, public dwViewerService: DwViewerService, public dwProfileViewerService: DwProfileViewerService, private router: Router, public route: ActivatedRoute, private routeLocation: Location) { }
