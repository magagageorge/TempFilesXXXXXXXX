...
@Component({
  selector: 'app-ad-post-catalog-widget',
  templateUrl: './ad-post-catalog-widget.component.html',
  styleUrls: ['./ad-post-catalog-widget.component.scss']
})
export class AdPostCatalogWidgetComponent implements OnInit {

  @Input() dispayContainer: number;
  @Input() cards: AdContentCardForm[];
  @Input() selectedCTA: CallToAction;
  boxWidth: number = 290;
