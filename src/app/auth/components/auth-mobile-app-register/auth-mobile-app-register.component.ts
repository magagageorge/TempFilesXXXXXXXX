...
@Component({
  selector: 'app-auth-mobile-app-register',
  templateUrl: './auth-mobile-app-register.component.html',
  styleUrls: ['./auth-mobile-app-register.component.scss']
})
export class AuthMobileAppRegisterComponent implements OnInit {
