...
@Component({
  selector: 'app-shared-edit-profile-education-widget',
  templateUrl: './edit-profile-education-widget.component.html',
  styleUrls: ['./edit-profile-education-widget.component.scss']
})
export class SharedEditProfileEducationWidgetComponent implements OnInit {
  ...
  delete() {
    this.editProfileService.ConfirmDeleteProfileEducation(this.editProfileService.editMode.education.inEditData);
  }
